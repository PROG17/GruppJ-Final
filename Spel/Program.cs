    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var office = new Room("You are in the office.\n" +
                ...
                "\"Player\" may only enter the living room from the office", "Office", 2);

            var bathroom = new Room("You are in the bathroom\n" +
                ...
                "\"Player\" may only enter the living room from the bathroom", "Bathroom",3);

            var diningRoom1 = new Room("You are in the dining room\n" +   //Innan Bedroom är upplåst
                ...
                "and then there is a closed door which probably lead to the bedroom.", "Dining Room",4);

            var diningRoom2 = new Room("You are in the dining room\n" +  //Efter Bedroom är upplåst
                "The dining room is pretty dark since it is placed in the center of the house, only a little moonlight finds its way to this room so \"Player\" " +
            ...
            var kitchen = new Room("You are in the kitchen\n" +
                ...
                "\"Player\" may only enter the dining room from the kitchen.", "Kitchen",7);

            var backyard = new Room("You are in the backyard\n" +
            ...
            var bedroom = new Room("You are in the Bedroom\n" +
                ...
                "\n\"Player\" can also see into the backyard through the window. ", "Beedroom", 6);


            var darkCellar = new Room("You are in the cellar\n" +
                                      ...
                                      "\n\"Player\" can't see anything. Only available exit is back to dining room.", "Cellar",5);


            var lightCellar = new Room("You are in the cellar\n" +
